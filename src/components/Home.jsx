            ...
            <div className="">
                <div className="lg:mx-40 text-center">
                    ...
                    <div className="">
                        ...
                        <button className="p-3 px-4 rounded-lg bg-forestGreen text-light sm:text-sm">Get Started</button>
                    </div>
                </div>
            </div>
                ...
                <div className="my-5 text-lg text-oxfordBlue lg:mr-16 lg:w-2/4">
                    ...
                    <div className="my-5">
                        ...
                        <div className="flex mb-5">
                            ...
                            <div>
                                <h5 className={`text-1xl font-semibold ${darkMode ? 'text-light' : 'text-oxfordBlue'} sm:text-sm`}>Download FarmVest</h5>
                                <p className={`text-sm ${darkMode ? 'text-lightGray' : 'text-oxfordBlue'} sm:text-xs`}>Start by downloading Ebilivie app on your Android or IOS</p>
                            </div>
                        </div>
                        ...
                        <div className="flex mb-5">
                            ...
                            <div>
                                <h5 className={`text-1xl font-semibold ${darkMode ? 'text-light' : 'text-oxfordBlue'} sm:text-sm`}>Create account</h5>
                                <p className={`text-sm ${darkMode ? 'text-lightGray' : 'text-oxfordBlue'} sm:text-xs`}>Start by downloading Ebilivie app on your Android or IOS</p>
                            </div>
                        </div>
                        ...
                        <div className="flex mb-5">
                            ...
                            <div>
                                <h5 className={`text-1xl font-semibold ${darkMode ? 'text-light' : 'text-oxfordBlue'} sm:text-sm`}>Link your bank account</h5>
                                <p className={`text-sm ${darkMode ? 'text-lightGray' : 'text-oxfordBlue'} sm:text-xs`}>Start by downloading Ebilivie app on your Android or IOS</p>
                            </div>
                        </div>
                        ...
                        <div className="flex mb-5">
                            ...
                            <div>
                                <h5 className={`text-1xl font-semibold ${darkMode ? 'text-lightGray' : 'text-oxfordBlue'} sm:text-sm`}>Start Investing</h5>
                                <p className={`text-sm ${darkMode ? 'text-lightGray' : 'text-oxfordBlue'} sm:text-xs`}>Start by downloading Ebilivie app on your Android or IOS</p>
                            </div>
                        </div>
                    </div>
                </div>
                <div className="py-2 px-5 lg:bg-semiLight sm:bg-semiLight rounded-xl lg:w-2/4">
                    ...
                    <div className="md:mt-10">
                        ...
                        <div className="sm:text-xs">
                            <div className="flex items-center my-5 sm:my-3">
                                <span className={`${darkMode ? 'bg-OxfordBlue2' : 'bg-semiLight'} rounded-full text-3xl font-bold text-forestGreen p-2 px-5 sm:px-3 mr-3 sm:text-sm`}>1</span>
                                <p>Real-time Checkup</p>
                            </div>
                            <div className="flex items-center my-5 sm:my-3">
                                <span className={`${darkMode ? 'bg-OxfordBlue2' : 'bg-semiLight'} rounded-full text-3xl font-bold text-forestGreen p-2 px-5 sm:px-3 mr-3 sm:text-sm`}>2</span>
                                <p>Flexibility in Investment</p>
                            </div>
                            <div className="flex items-center my-5 sm:my-3">
                                <span className={`${darkMode ? 'bg-OxfordBlue2' : 'bg-semiLight'} rounded-full text-3xl font-bold text-forestGreen p-2 px-5 sm:px-3 mr-3 sm:text-sm`}>3</span>
                                <p>Encrypted and Secured</p>
                            </div>
                            <div className="flex items-center my-5 sm:my-3">
                                <span className={`${darkMode ? 'bg-OxfordBlue2' : 'bg-semiLight'} rounded-full text-3xl font-bold text-forestGreen p-2 px-5 sm:px-3 mr-3 sm:text-sm`}>4</span>
                                <p>Withdraw Anytime</p>
                            </div>
                            <div className="my-10">
                                <a href="#" className='bg-forestGreen p-3 px-8 text-semiLight rounded-lg md:text-sm'>Learn More</a>
                            </div>
                        </div>
                    </div>
            ...
            <div className="my-16">
                <div>
                    ...
                    <div className="my-10 text-center">
                        <a href="#" className='bg-forestGreen p-3 px-8 text-semiLight rounded-lg md:text-sm sm:text-xs'>View All</a>
                    </div>
                </div>
            </div>
