    ...
    return (
        <div className='lg:my-12'>
            ...
            <div className="flex flex-wrap justify-center">
                {orders?.map(order => (
                    <div key={order.id} className={`lg:p-10 m-3 md:p-5 lg:mr-5 mb-5 ${darkMode ? 'border border-[#008000]' : 'bg-[#f2f8f2]'} rounded-xl w-80 md:max-w-48 sm:p-5`}>
                        ...
                        <button className="hover:bg-[#008000] lg:p-5 md:p-2 sm:p-2 hover:text-white lg:text-1xl lg:font-bold rounded-lg border border-[#008000]">Contact Customer</button>
                    </div>
                ))}
            </div>
        </div>
